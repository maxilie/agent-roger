...
export const ABSTRACT_TASK_STAGE_FNS: { [key: string]: StageFunction } = {
  ...
  generateSemanticContextQueries: async (helpers: StageFunctionHelpers) => {
    // TODO
  ...
  // eslint-disable-next-line @typescript-eslint/require-await
  generateKeywordContextQueries: async (helpers: StageFunctionHelpers) => {
    // TODO
  ...
  // eslint-disable-next-line @typescript-eslint/require-await
  generateSemanticQueryEmbeddings: async (helpers: StageFunctionHelpers) => {
    // TODO
  ...
  // eslint-disable-next-line @typescript-eslint/require-await
  queryRawContext: async (helpers: StageFunctionHelpers) => {
    // TODO
    // Queries the document database using the semantic context query vector(s) and the keywords queries.
    helpers.endStage();
  },
  // eslint-disable-next-line @typescript-eslint/require-await
  summarizeContext: async (helpers: StageFunctionHelpers) => {
    // TODO
    helpers.endStage();
  },
